...
activities = {
    ...
    "Art Studio": {
        "description": "Explore painting, drawing, and multimedia art projects",
        "schedule": "Wednesdays, 3:30 PM - 5:00 PM",
        "max_participants": 16,
        "participants": ["harper@mergington.edu", "cameron@mergington.edu"]
    },
    "Drama Workshop": {
        "description": "Acting exercises, script reading, and stage performance",
        "schedule": "Fridays, 4:00 PM - 5:30 PM",
        "max_participants": 14,
        "participants": ["avery@mergington.edu", "riley@mergington.edu"]
    },
    "Science Olympiad": {
